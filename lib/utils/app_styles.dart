...
Color primary = const Color(0xFF168aad);
// Color secondary = const Color(0xFF526799);
Color secondary = const Color(0xFFAD3916);
...
class Styles {
  ...
  static Color inActiveTabColor = const Color(0xFFF4F6FD);
  static Color tealGreen = const Color(0xFF3Ab8b8);
  static Color tealGreenDark  = const Color(0xFF189999);
  static Color orange  = const Color(0xFFEC6545);
